    ...
    <>
      ...
      <Grid>
        <Column size={7} overflow="hidden">
          {!!page.localization.getText(2) && <Text dangerouslySetInnerHTML={{__html: page.localization.getText(2)}} />}
        ...
        <Column size={5} overflow="hidden" gap={1}>
          ...
          <Column grow position="relative" overflow="hidden" gap={0}>
            {!!page.localization.getImage(1) && <img alt="" className="flex-grow-1" src={page.localization.getImage(1)} />}
