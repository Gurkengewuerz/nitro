import {GetMarketplaceConfigurationMessageComposer, MakeOfferMessageComposer, MarketplaceConfigurationEvent} from "@nitro/renderer";
        ...
        <Grid fullHeight>
          ...
          <Column size={8} justifyContent="between" overflow="hidden">
            <Column grow gap={1}>
              ...
              <Text truncate shrink>
                {getFurniDescription}
              </Text>
            </Column>
            <Column overflow="auto">
              <Text italics>{LocalizeText("inventory.marketplace.make_offer.expiration_info", ["time"], [marketplaceConfiguration.offerTime.toString()])}</Text>
              ...
              <Button
                disabled={askingPrice < marketplaceConfiguration.minimumPrice || askingPrice > marketplaceConfiguration.maximumPrice || isNaN(askingPrice)}
                onClick={postItem}
              >
