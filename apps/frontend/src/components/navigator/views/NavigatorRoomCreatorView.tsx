...
import {CreateFlatMessageComposer, HabboClubLevelEnum} from "@nitro/renderer";
...
export const NavigatorRoomCreatorView: FC<{}> = props => {
  ...
  return (
    <Column overflow="hidden">
      ...
      <Button fullWidth variant={!name || name.length < 3 ? "danger" : "success"} onClick={createRoom} disabled={!name || name.length < 3}>
