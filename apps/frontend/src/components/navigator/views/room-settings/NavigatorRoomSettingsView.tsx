import {RoomBannedUsersComposer, RoomDataParser, RoomSettingsDataEvent, SaveRoomSettingsComposer} from "@nitro/renderer";
  ...
  return (
    <NitroCardView uniqueKey="nitro-room-settings" className="nitro-room-settings">
      ...
      <NitroCardContentView>
        {currentTab === TABS[0] && <NavigatorRoomSettingsBasicTabView roomData={roomData} handleChange={handleChange} onClose={onClose} />}
        {currentTab === TABS[1] && <NavigatorRoomSettingsAccessTabView roomData={roomData} handleChange={handleChange} />}
        {currentTab === TABS[2] && <NavigatorRoomSettingsRightsTabView roomData={roomData} handleChange={handleChange} />}
        {currentTab === TABS[3] && <NavigatorRoomSettingsVipChatTabView roomData={roomData} handleChange={handleChange} />}
        {currentTab === TABS[4] && <NavigatorRoomSettingsModTabView roomData={roomData} handleChange={handleChange} />}
      </NitroCardContentView>
    </NitroCardView>
  );
};
