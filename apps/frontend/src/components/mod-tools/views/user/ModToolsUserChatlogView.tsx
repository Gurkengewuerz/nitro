import {ChatRecordData, GetUserChatlogMessageComposer, UserChatlogEvent} from "@nitro/renderer";
...
export const ModToolsUserChatlogView: FC<ModToolsUserChatlogViewProps> = props => {
  ...
  return (
    <NitroCardView className="nitro-mod-tools-chatlog" theme="primary-slim" windowPosition={DraggableWindowPosition.TOP_LEFT}>
      ...
      <NitroCardContentView className="text-black h-100">{userChatlog && <ChatlogView records={userChatlog} />}</NitroCardContentView>
    </NitroCardView>
  );
};
