  ...
  return (
    <>
      ...
      <Grid className="d-flex align-items-center justify-content-end gap-2">
        <Button className="btn btn-primary w-100 btn-sm" onClick={event => setIsEditingPromote(true)}>
          {LocalizeText("navigator.roominfo.editevent")}
        </Button>
        <Button className="btn btn-success w-100 btn-sm" onClick={event => extendPromote()}>
