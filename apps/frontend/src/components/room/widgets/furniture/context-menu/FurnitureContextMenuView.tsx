    ...
    switch (parser.count) {
      ...
      case 2:
        simpleAlert(
          ...
          null,
          "catalog/open/" + (GetConfiguration<any>("catalog.links")["hc.buy_hc"]),
        ...
        <ContextMenuView objectId={objectId} category={RoomObjectCategory.FLOOR} onClose={onClose} fades={true}>
          {mode === ContextMenuEnum.FRIEND_FURNITURE && (
            <>
              ...
              <ContextMenuListItemView onClick={event => processAction("use_friend_furni")}>{LocalizeText("friendfurni.context.use")}</ContextMenuListItemView>
            </>
          )}
