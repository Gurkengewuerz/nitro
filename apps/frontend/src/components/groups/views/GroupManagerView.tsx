import {GroupBadgePart, GroupInformationEvent, GroupSettingsEvent} from "@nitro/renderer";
    ...
    <NitroCardView className="nitro-group-manager">
      ...
      <NitroCardContentView>
        ...
        <Column grow overflow="hidden">
          {currentTab === 1 && <GroupTabIdentityView groupData={groupData} setGroupData={setGroupData} setCloseAction={setCloseAction} onClose={onClose} />}
          {currentTab === 2 && <GroupTabBadgeView groupData={groupData} setGroupData={setGroupData} setCloseAction={setCloseAction} skipDefault={true} />}
          {currentTab === 3 && <GroupTabColorsView groupData={groupData} setGroupData={setGroupData} setCloseAction={setCloseAction} />}
          {currentTab === 5 && <GroupTabSettingsView groupData={groupData} setGroupData={setGroupData} setCloseAction={setCloseAction} />}
        </Column>
      </NitroCardContentView>
    </NitroCardView>
  );
