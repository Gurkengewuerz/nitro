  ...
  return (
    <Flex fullWidth justifyContent={isOwnChat ? "end" : "start"} gap={2}>
      <Base shrink className="message-avatar">
        {group.type === MessengerGroupType.PRIVATE_CHAT && !isOwnChat && <LayoutAvatarImageView figure={thread.participant.figure} direction={2} />}
        {groupChatData && !isOwnChat && <LayoutAvatarImageView figure={groupChatData.figure} direction={2} />}
      </Base>
