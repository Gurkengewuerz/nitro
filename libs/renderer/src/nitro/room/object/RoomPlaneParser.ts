...
export class RoomPlaneParser {
    ...
    while (_local_3 < _local_2) {
      if (!k.getHideWall(_local_3)) {
        ...
        while (_local_10 < _local_6) {
          if (
            this.getTileHeightInternal(_local_4.x + _local_10 * _local_7.x - _local_8.x, _local_4.y + _local_10 * _local_7.y - _local_8.y) ==
  ...
  private createWallPlanes(): boolean {
    ...
    const _local_7: number = Math.min(
      RoomPlaneParser.MAX_WALL_ADDITIONAL_HEIGHT,
      this._fixedWallHeight != -1 ? this._fixedWallHeight : RoomPlaneParser.getFloorHeight(k)
    );
  ...
  private addWall(k: IVector3D, _arg_2: IVector3D, _arg_3: IVector3D, _arg_4: IVector3D, _arg_5: boolean, _arg_6: boolean, _arg_7: boolean): void {
    ...
    if (_arg_5) {
      this.addPlane(
        ...
        Vector3d.sum(Vector3d.sum(k, _arg_2), _arg_3),
        Vector3d.product(_arg_3, -(_arg_3.length + _local_9) / _arg_3.length),
        _local_11,
        [_local_10, _arg_4]
      );
    }
    if (_arg_6) {
      this.addPlane(
        RoomPlaneData.PLANE_WALL,
        Vector3d.sum(k, Vector3d.product(_arg_3, -_local_9 / _arg_3.length)),
        Vector3d.product(_arg_3, (_arg_3.length + _local_9) / _arg_3.length),
        _local_11,
        [_local_10, _arg_4]
      );
      if (_arg_7) {
        ...
        this.addPlane(RoomPlaneData.PLANE_WALL, Vector3d.sum(Vector3d.sum(k, _arg_3), Vector3d.product(_local_12, -1)), _local_12, _local_11, [
          _local_10,
          _arg_2,
          _arg_4,
        ]);
      ...
      while (_local_7 < _local_3) {
        ...
        if (_local_8 < 0 || _local_4[_local_6][_local_7]) {
          ...
          while (_local_9 < _local_3) {
            if (
              !(k[_local_6][_local_9] == _local_8) ||
              _local_4[_local_6][_local_9] ||
              (_local_6 > 0 && (k[_local_6 - 1][_local_9] == _local_8) == _local_12)
            ) {
              break;
            }
            _local_9++;
          ...
          while (_local_10 < _local_2 && !_local_17) {
            ...
            _local_17 =
              _local_14 ||
              (_local_7 > 0 && (k[_local_10][_local_7 - 1] == _local_8) == _local_11) ||
              (_local_9 < _local_3 && (k[_local_10][_local_9] == _local_8) == _local_13);
            _local_15 = _local_7;
          ...
          this.addFloor(
            new Vector3d(_local_18 + _local_20, _local_19 + _local_21, _local_8 / 4),
            new Vector3d(-_local_20, 0, 0),
            new Vector3d(0, -_local_21, 0),
            _local_13,
            _local_11,
            _local_14,
            _local_12
