...
export class RoomSpriteCanvas implements IRoomRenderingCanvas {
  ...
  private doMagic(): void {
    ...
    if (this._rotation !== 0) {
      ...
      location.x =
        location.x + this._rotationRodLength * Math.cos(((direction.x + 180) / 180) * 3.14159265358979) * Math.cos((direction.y / 180) * 3.14159265358979);
      location.y =
        location.y + this._rotationRodLength * Math.sin(((direction.x + 180) / 180) * 3.14159265358979) * Math.cos((direction.y / 180) * 3.14159265358979);
    ...
    if (this._SafeStr_4507) {
      ...
      const _local_1 = Vector3d.sum(
        _local_4,
        new Vector3d(
          Math.sin(((this._SafeStr_795 * 5) / 180) * 3.14159265358979) * 2,
          Math.sin((this._SafeStr_795 / 180) * 3.14159265358979) * 5,
          Math.sin(((this._SafeStr_795 * 10) / 180) * 3.14159265358979) * 2
        )
      );
